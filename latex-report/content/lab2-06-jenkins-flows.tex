...
\caption{Scaffold ảnh Jenkins main build chạy qua CI gates và Docker push}
\end{figure}

\begin{figure}[H]
\centering
\reportimg{img/dockerhub/dev_commit_sha_tags.png}
\caption{Scaffold ảnh Docker Hub hiển thị image tag theo commit SHA cho dev}
\end{figure}
...
\begin{figure}[H]
\centering
\reportimg{img/jenkins/release_v012_success.png}
\caption{Scaffold ảnh Jenkins release tag \texttt{v0.1.2} promote thành công}
\end{figure}
...
\hline
\texttt{v0.1.2} & Thành công. & Promote theo tag nguồn từng service đọc từ dev overlay; release tag là promote-only. \\
\hline
\end{tabular}
\end{table}
