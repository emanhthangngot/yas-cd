...
\begin{figure}[H]
\centering
\reportimg{img/security/gitleaks-scan-success.png}
\caption{Stage Secret Scanning chạy thành công (không phát hiện secret)}
\end{figure}

\begin{figure}[H]
\centering
\reportimg{img/security/gitleaks-scan-failed.png}
...
\begin{figure}[H]
\centering
\reportimg{img/security/sonarqube-dashboard.png}
\caption{SonarQube Dashboard: project \texttt{yas} với Quality Gate Passed}
\end{figure}

\begin{figure}[H]
\centering
\reportimg{img/security/sonarqube-pipeline-stages.png}
\caption{Jenkins pipeline: stage Code Quality và Quality Gate chạy thành công}
\end{figure}

\begin{figure}[H]
\centering
\reportimg{img/security/sonarqube-build-success.png}
